...
from Kiwoom import *
from per_pbr_moving_avg import moving_avg

form_class = uic.loadUiType("pytrader_v_1_1_0.ui")[0]
        ...
        for j in range(item_count):
            ...
            for i in range(len(column)):
                ...
                if i<2:   # 테이블 데이터 정렬을 위해 숫자와 문자열 구분하여 입력
                    ...
                    item_refresh.setData(Qt.DisplayRole, float(column[i])) # 실 계좌에서 수익율은 가상계좌 대비 1/100)
                    self.tableWidget_2.setItem(j, i+1, item_refresh)
