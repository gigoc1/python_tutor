...
from PyQt5.QtWidgets import QMainWindow, QApplication, QTableWidget, \
    QTableWidgetItem, QAbstractItemView, QTextEdit, QPushButton, QCheckBox
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.tablewidget.setRowCount(4) # 행 개수
    ...
    def insert_data(self):
        self.tablewidget.setItem(1, 1, QTableWidgetItem("1행 1열"))
        self.tablewidget.setItem(1, 2, QTableWidgetItem("1행 2열"))
        self.tablewidget.setItem(2, 1, QTableWidgetItem("2행 1열"))
        self.tablewidget.setItem(2, 2, QTableWidgetItem("2행 2열"))
